...
class IndexHandler(RequestHandler):
    ...
    def initialize(self,inputNetwork,cameraPort,mapPort,audioPort,cameraHost,resFinder,absPath,audioBufferLen,mapHost=None,audioHost=None,isSsl=False,simulate=False):
        ...
        self.audioHost = audioHost if audioHost is not None else cameraHost
